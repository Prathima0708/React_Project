...
const AuthForm = () => {
  ...
  const submitHandler = (event) => {
    ...
    if (isLogin) {
      url =
        'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDFdhqV0mWVEuPjRq5t25omJJWRlYnJbh8';
    } else {
      url =
        'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDFdhqV0mWVEuPjRq5t25omJJWRlYnJbh8';
    }
    fetch(url, {
      method: 'POST',
      body: JSON.stringify({
